...
def generate_launch_description():
    ...
    parameters_file_path = os.path.join(parameters_file_dir, 'dual_ekf_navsat_gps_uwb.yaml')
    rviz_config_dir = os.path.join(robot_localization_dir, 'rviz', 'tb3_gazebo_robot_localization.rviz')
